...
RSpec.describe ValidatesIdentity::PeRuc::LegalValidator do
  it 'accepts 20601313490' do
    expect(described_class.new('20601313490')).to be_valid
  end

  it 'accepts 20754821231' do
    expect(described_class.new('20754821231')).to be_valid
  end

  it 'accepts 20186563124' do
    expect(described_class.new('20186563124')).to be_valid
  end
